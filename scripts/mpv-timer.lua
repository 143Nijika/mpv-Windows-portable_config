...
mp.add_key_binding("Alt+q", "set-start-time", set_start_time)
mp.add_key_binding("Alt+w", "set-end-time", set_end_time)
mp.add_key_binding("Alt+e", "print-time", print_time)
